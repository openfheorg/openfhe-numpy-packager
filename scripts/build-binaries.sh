...
OPENFHE_PYTHON_CMAKE_ARGS=${OPENFHE_PYTHON_CMAKE_ARGS}" -DOpenFHE_DIR=${OPENFHE_INSTALL_DIR}/lib/OpenFHE"
...
OPENFHE_NUMPY_CMAKE_ARGS=${OPENFHE_NUMPY_CMAKE_ARGS}" -DOpenFHE_DIR=${OPENFHE_INSTALL_DIR}/lib/OpenFHE"
